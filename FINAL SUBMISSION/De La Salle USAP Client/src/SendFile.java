...
public class SendFile extends javax.swing.JFrame {
    ...
    /*
        GUI for when "Submit File" button has been pressed
    */
    ...
    /*   Thread that sends data transfer request to server   */
        ...
        public void run() {
            try {
                while(!Thread.currentThread().isInterrupted()){
                    String data = dis.readUTF();  // Reads contents of data received from sender
                    st = new StringTokenizer(data);
                    String cmd = st.nextToken();  //  Gets first word of data
                    switch(cmd){
    ...
    private void initComponents() {
        ...
        btnBrowse.setBackground(new java.awt.Color(0, 102, 0));
        btnBrowse.setFont(new java.awt.Font("Garamond", 1, 13)); // NOI18N
        ...
        btnSendFile.setBackground(new java.awt.Color(0, 102, 0));
        btnSendFile.setForeground(new java.awt.Color(255, 255, 255));
        btnSendFile.setText("Submt file");
    ...
    private void btnSendFileActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_btnSendFileActionPerformed
        ...
        if((sendTo.length() > 0) && (file.length() > 0)){
            try {
                ...
                dos.writeUTF(format);
                System.out.println(format);
                updateBtn("Sending out...");
                btnSendFile.setEnabled(false);
            } catch (IOException e) {
                System.out.println(e.getMessage());
            }
        }else{
            JOptionPane.showMessageDialog(this, "Left blank!","Error", JOptionPane.ERROR_MESSAGE);
        }
