        ...
        try {
            while(!Thread.currentThread().isInterrupted()){
                ...
                switch(CMD){
                    ...
                    //   Receives a file in the background
                    case "CMD_SENDFILE":
                        String consignee = null;
                            try {
                                ...
                                String path = main.getMyDownloadFolder() + "." + filename.substring(filename.lastIndexOf('.')+1);                                
                                /*  Creat Stream   */
