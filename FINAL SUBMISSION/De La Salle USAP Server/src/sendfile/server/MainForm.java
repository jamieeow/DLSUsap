...
public class MainForm extends javax.swing.JFrame {
    ...
    public void setSocketList(Socket socket){
        try {
            ...
            appendMessage("[setSocketList]: New client connected: " + socket.getRemoteSocketAddress());
        ...
        for(int x=0; x < clientFileSharingUsername.size(); x++){
            if(clientFileSharingUsername.elementAt(x).equals(username)){
                try {
                    ...
                    appendMessage("[FileSharing]: Could not cancel"+ username);
                }
                break;
            }
        }
    ...
    private void initComponents() {
        ...
        jLabel2.setIcon(new javax.swing.ImageIcon(getClass().getResource("/sendfile/server/Archer.png"))); // NOI18N
        jLabel2.setText("De La Salle USAP");
    ...
    private void jButton2ActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_jButton2ActionPerformed
        // TODO add your handling code here:
        int confirm = JOptionPane.showConfirmDialog(null, "End server?");
        if(confirm == 0){
            serverThread.stop();
        }
