...
public class SocketThread implements Runnable {
    ...
    /*   Establish connection with current client socket   */
    private void createConnection(String receiver, String sender, String filename) {
        try {
            ...
            if (s != null) { // Client already exists
                ...
                dos.writeUTF("CMD_SENDFILEERROR " + "Client '" + receiver + "' not found in the list!");
            }
        } catch (IOException e) {
    ...
    public void run() {
        try {
            while (true) {
                ...
                switch (CMD) {
                    case "CMD_JOIN":
                        ...
                        main.appendMessage("[Client]: " + clientUsername + " has joined the chat room!");
                        break;
                    ...
                    case "CMD_CHATALL":
                        ...
                        {
                            Socket tsoc2 = (Socket) main.socketList.elementAt(0);
                            DataOutputStream dos2 = new DataOutputStream(tsoc2.getOutputStream());
                            dos2.writeUTF("CMD_NO_PARTNER_MESSAGE");
                        }
                        break;

                    case "CMD_SHARINGSOCKET":
                        main.appendMessage("CMD_SHARINGSOCKET : Client establishing connection for file sharing connection...");
                        ...
                        main.appendMessage("CMD_SHARINGSOCKET : File sharing opened!");
                        break;
                    ...
                    case "CMD_SENDFILE":
                        ...
                        if (cSock != null) { /* Exists   */
                            ...
                            try {
                                ...
                                main.appendMessage("CMD_SENDFILE : File has been sent to client");
                            } catch (IOException e) {
                            ...
                            DataOutputStream dos = new DataOutputStream(socket.getOutputStream());
                            dos.writeUTF("CMD_SENDFILEERROR " + "Client '" + sendto + "' not found, File sharing will now exit.");
                        }
                        break;
                    ...
                    case "CMD_SENDFILERESPONSE":
                         ...
                         */
                        String receiver = st.nextToken(); // Get receiver username method
                    ...
                    case "CMD_SEND_FILE_ERROR":  // Format:  CMD_SEND_FILE_ERROR [receiver] [Message]
                        ...
                        try {
                            ...
                            Socket eSock = main.getClientFileSharingSocket(eReceiver); // Receive file sharing host socket for connection Method
                    ...
                    case "CMD_EXIT_LOGS":
                        ...
                        {
                            DataOutputStream dos = new DataOutputStream(socket.getOutputStream());
                            dos.writeUTF("CMD_SAVE_EXIT_LOGS " + main.getTextArea().getText());
                        }
                        catch (IOException e)
                        {
                            main.appendMessage("[CMD_RECEIVE_FILE_ERROR]: " + e.getMessage());
            ...
            main.appendMessage("[SocketThread]: Client connection has closed!");
        }
    }
